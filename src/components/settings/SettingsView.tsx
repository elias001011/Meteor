...
import { XIcon, LightbulbIcon, SparklesIcon, ChevronLeftIcon, GaugeIcon, HeartIcon, InfoIcon } from '../icons';
...
interface SettingsViewProps {
    ...
    onReplayIntro?: () => void; // Added new prop
}
            ...
            <section className={`rounded-3xl ${density.padding} ${cardClass}`}>
                ...
                <div className={density.settingsGap}>
                    ...
                    {onReplayIntro && (
                         <div className="flex items-center justify-between pt-4 border-t border-white/5">
                            <div className="flex flex-col gap-0.5">
                                <span className={`${density.text} text-white font-medium`}>Rever Apresentação</span>
                                <span className="text-xs text-gray-400">Visualizar a página inicial do app novamente.</span>
                            </div>
                            <button 
                                onClick={onReplayIntro}
                                className="px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white text-sm font-medium transition-colors border border-white/5"
                            >
                                Abrir
                            </button>
                        </div>
